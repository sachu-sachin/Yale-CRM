...
export default function AdminChatPage() {
  ...
  return (
    <>
      <Header title="Messages" subtitle="Direct chat with telecallers" />
      <div className="p-6">
        <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden flex" style={{ height: "calc(100vh - 160px)" }}>
          ...
          <div className="w-80 border-r border-slate-100 flex flex-col">
            <div className="p-4 border-b border-slate-50">
              <h3 className="font-semibold text-slate-900 text-sm">Telecallers</h3>
            </div>
                ...
                contacts.map((contact) => (
                  <button
                    ...
                    className={cn(
                      ...
                      selected?.id === contact.id && "bg-indigo-50 hover:bg-indigo-50"
                    )}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {contact.lastMessage && (
                        <p className="text-xs text-slate-400 truncate">{contact.lastMessage.content}</p>
                      )}
                    </div>
                  </button>
                ))
            ...
            {selected ? (
                    ...
                    return (
                      <div key={msg.id} className={cn("flex", isMine ? "justify-end" : "justify-start")}>
                        <div className={cn(
                          ...
                          <p>{msg.content}</p>
                          <p className={cn("text-[10px] mt-1", isMine ? "text-indigo-200" : "text-slate-400")}>
              ...
              <div className="flex-1 flex items-center justify-center text-slate-400">
                <div className="text-center">
                  ...
                  <p className="text-sm">Select a telecaller to start chatting</p>
                </div>
              </div>
            )}
          </div>
